const translationProps = {
    uploadStep: {
        ...
        maxRecordsExceeded: (maxRecords) =>
            `יותר מדיי שורות. עד ${maxRecords} שורות מותרות`,
        dropzone: {
    ...
    matchColumnsStep: {
        ...
        duplicateColumnWarningDescription:
            "עמודות חייבות להיות עם כותרת ייחודית",
    },
    validationStep: {
        title: "וידוא מידע",
    ...
    alerts: {
        ...
        submitIncomplete: {
            ...
            bodyText:
                "יש עדיין שורות עם שגיאה בתוכן. שורות עם שגיאות יתעלמו בעת הגשה.",
        ...
        unmatchedRequiredFields: {
            ...
            bodyText:
                "יש עמודות חובה שלא תואמות או שנבחר להתעלם מהן. האם ברצונך להמשיך?",
